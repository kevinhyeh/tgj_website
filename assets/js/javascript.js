const mainPages =
	window.location.href ==
		'file:///Users/kevinyeh/Desktop/Desktop/the_graphic_jar/tgj_website/index.html' ||
	window.location.href ==
		'file:///Users/kevinyeh/Desktop/Desktop/the_graphic_jar/tgj_website/projects.html' ||
	window.location.href ==
		'file:///Users/kevinyeh/Desktop/Desktop/the_graphic_jar/tgj_website/contact.html'
	...
	$(document).on('scroll', function() {
		if ($(document).scrollTop()) {
			...
			if (window.matchMedia('(min-width: 781px)').matches && mainPages) {
				...
				$('.nav_brand-logo').attr(
					'src',
					'../../assets/svg/tgj_new_logo(white).svg'
				)
			}
...
$('.client__project').on('click', function() {
	...
	if ($(this).attr('id') === 'project-1') {
		changeProject(
			'#c78f58',
			'url("assets/images/projects/project-1/project-1-bg.jpg")',
			'public/clients-page/tell-their-stories.html',
			'Tell Their Stories',
			'Tell their Stories is a multi-media project that aims to give a voice to individuals who have been affected by mass incarceration.'
		)
	} else if ($(this).attr('id') === 'project-2') {
		changeProject(
			'#aa4f51',
			'url("assets/images/projects/project-2/project-2-bg.jpg")',
			'public/clients-page/green-goddess-gardens.html',
		...
		changeProject(
			'#ac8c66',
			'url("assets/images/projects/project-3/project-3-bg.jpg")',
			'public/clients-page/the-forest-floor.html',
			'The Forest Floor',
			'The Forest Floor wanted a logo that represents their brand and had the similar feel to the National Forest Sign that we all know and love.'
		)
	} else if ($(this).attr('id') === 'project-4') {
		changeProject(
			'#499b04',
			'url("assets/images/projects/project-4/project-4-bg.jpg")',
			'public/clients-page/gusto-di-roma.html',
			'Gusto di Roma',
			'Eating authentic Italian food at home can be simple. I personally select a variety of ready-to-eat small bites and mail flavors of Italy to you once a month.'
		)
	}
	setTimeout(removeAnimation, 1000)
})
